...
-- Households
INSERT INTO edw_dev_hris.hgv_comp.dim_household VALUES
...
-- Locations
INSERT INTO edw_dev_hris.hgv_comp.dim_location VALUES
...
-- Guests
INSERT INTO edw_dev_hris.hgv_comp.dim_guest VALUES
...
-- Tour-guest bridge
INSERT INTO edw_dev_hris.hgv_comp.bridge_tour_guest VALUES
  ('T-55122', 'GUEST-001', TRUE),
  ('T-55204', 'GUEST-002', TRUE),
  ('T-55180', 'GUEST-003', TRUE);

-- Ownership
INSERT INTO edw_dev_hris.hgv_comp.fact_guest_ownership VALUES
  ('OWN-003-01', 'GUEST-003', 'Orlando Collection — West 57th', 'LOC-ORL-W57', 'ACTIVE', 12400, 'HGV');

-- Rental / exchange stays
INSERT INTO edw_dev_hris.hgv_comp.fact_guest_rental_stay VALUES
...
-- Prior tour history
INSERT INTO edw_dev_hris.hgv_comp.fact_guest_tour_history VALUES
...
WHERE NOT EXISTS (SELECT 1 FROM edw_dev_hris.hgv_comp.fact_tour_quality WHERE tour_id = 'T-55122');

INSERT INTO edw_dev_hris.hgv_comp.fact_tour_quality
  (tour_id, rep_id, period_id, lead_source, abc_score, package_type, showed_flag, closed_flag, contract_status, rescission_flag, net_sales_volume, vpg, ebitda_estimate)
SELECT 'T-55204', 'PERSONA-MKT-REP', '2026-Q2', 'OPC', 'C', 'Discovery', TRUE, FALSE, 'NONE', FALSE, 0, 0, 0
WHERE NOT EXISTS (SELECT 1 FROM edw_dev_hris.hgv_comp.fact_tour_quality WHERE tour_id = 'T-55204');

INSERT INTO edw_dev_hris.hgv_comp.fact_tour_quality
  (tour_id, rep_id, period_id, lead_source, abc_score, package_type, showed_flag, closed_flag, contract_status, rescission_flag, net_sales_volume, vpg, ebitda_estimate)
SELECT 'T-55180', 'PERSONA-MKT-REP', '2026-Q2', 'Owner', 'B', 'Preview', FALSE, FALSE, 'NONE', FALSE, 0, 0, 0
WHERE NOT EXISTS (SELECT 1 FROM edw_dev_hris.hgv_comp.fact_tour_quality WHERE tour_id = 'T-55180');

-- Link marketing tour payout rows to guest spine
UPDATE edw_dev_hris.hgv_comp.fact_marketing_tour_payout SET
  guest_id = 'GUEST-001',
  household_id = 'HH-001',
