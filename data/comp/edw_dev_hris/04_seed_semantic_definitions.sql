...
DELETE FROM edw_dev_hris.hgv_comp.semantic_definitions;

INSERT INTO edw_dev_hris.hgv_comp.semantic_definitions 
...
VALUES
  (
    ...
    'KPI',
    'SUM(total_earnings)',
    'edw_dev_hris.hgv_comp.fact_payout',
    'comp-ops@hgv.com',
    current_timestamp(),
    current_timestamp(),
    true
  ...
  (
    ...
    'Measure',
    'AVG(attainment_pct)',
    'edw_dev_hris.hgv_comp.fact_quota_attainment',
    'sales-ops@hgv.com',
    current_timestamp(),
    current_timestamp(),
    true
  ...
  (
    ...
    'edw_dev_hris.hgv_comp.fact_payout, edw_dev_hris.hgv_comp.fact_quota_attainment',
    'finance@hgv.com',
    current_timestamp(),
    current_timestamp(),
    true
