...
DELETE FROM edw_dev_hris.hgv_comp.industry_comp_benchmark WHERE effective_period = '2026-Q2';
DELETE FROM edw_dev_hris.hgv_comp.fact_marketing_rep_period WHERE period_id = '2026-Q2' AND rep_id = 'PERSONA-MKT-REP';
DELETE FROM edw_dev_hris.hgv_comp.fact_marketing_rep_metric WHERE period_id = '2026-Q2' AND rep_id = 'PERSONA-MKT-REP';
DELETE FROM edw_dev_hris.hgv_comp.fact_marketing_tour_payout WHERE period_id = '2026-Q2' AND rep_id = 'PERSONA-MKT-REP';
DELETE FROM edw_dev_hris.hgv_comp.fact_marketing_chargeback WHERE period_id = '2026-Q2' AND rep_id = 'PERSONA-MKT-REP';
DELETE FROM edw_dev_hris.hgv_comp.fact_marketing_arrival WHERE period_id = '2026-Q2' AND rep_id = 'PERSONA-MKT-REP';
DELETE FROM edw_dev_hris.hgv_comp.fact_rep_market_position WHERE period_id = '2026-Q2';
...
WHERE NOT EXISTS (SELECT 1 FROM edw_dev_hris.hgv_comp.dim_rep WHERE rep_id = 'PERSONA-MKT-REP');

INSERT INTO edw_dev_hris.hgv_comp.dim_rep
  (rep_id, rep_name, level_code, team_id, manager_rep_id, region, is_active)
SELECT 'PERSONA-MKT-MGR', 'R. Castillo', 'C2b', 'TEAM-MKT-LAS', NULL, 'West', TRUE
WHERE NOT EXISTS (SELECT 1 FROM edw_dev_hris.hgv_comp.dim_rep WHERE rep_id = 'PERSONA-MKT-MGR');

INSERT INTO edw_dev_hris.hgv_comp.dim_rep
  (rep_id, rep_name, level_code, team_id, manager_rep_id, region, is_active)
SELECT 'PERSONA-MKT-DIR', 'D. Whitfield', 'C2c', 'TEAM-MKT-REG', NULL, 'West', TRUE
WHERE NOT EXISTS (SELECT 1 FROM edw_dev_hris.hgv_comp.dim_rep WHERE rep_id = 'PERSONA-MKT-DIR');

INSERT INTO edw_dev_hris.hgv_comp.industry_comp_benchmark VALUES
...
INSERT INTO edw_dev_hris.hgv_comp.fact_marketing_rep_period VALUES (
...
INSERT INTO edw_dev_hris.hgv_comp.fact_marketing_rep_metric VALUES
...
INSERT INTO edw_dev_hris.hgv_comp.fact_marketing_tour_payout VALUES
...
INSERT INTO edw_dev_hris.hgv_comp.fact_marketing_chargeback VALUES
...
INSERT INTO edw_dev_hris.hgv_comp.fact_marketing_arrival VALUES
...
INSERT INTO edw_dev_hris.hgv_comp.fact_rep_market_position VALUES
