-- HGV Sales Compensation — synthetic star schema for POC
-- Target: workspace.hgv_comp (change catalog/schema if your workspace differs)
--
-- Run once on a SQL warehouse (uses workspace managed catalog).
...
CREATE OR REPLACE TABLE workspace.hgv_comp.dim_team (
...
CREATE OR REPLACE TABLE workspace.hgv_comp.dim_rep (
...
CREATE OR REPLACE TABLE workspace.hgv_comp.dim_period (
...
CREATE OR REPLACE TABLE workspace.hgv_comp.dim_plan_version (
...
CREATE OR REPLACE TABLE workspace.hgv_comp.dim_product_line (
...
CREATE OR REPLACE TABLE workspace.hgv_comp.fact_quota_attainment (
  rep_id STRING NOT NULL,
  period_id STRING NOT NULL,
  plan_version_id STRING NOT NULL,
...
CREATE OR REPLACE TABLE workspace.hgv_comp.fact_payout (
  rep_id STRING NOT NULL,
  period_id STRING NOT NULL,
...
CREATE OR REPLACE TABLE workspace.hgv_comp.fact_deal_credit (
...
CREATE OR REPLACE TABLE workspace.hgv_comp.fact_team_snapshot (
  team_id STRING NOT NULL,
  period_id STRING NOT NULL,
...
CREATE OR REPLACE TABLE workspace.hgv_comp.fact_rep_product_mix (
  rep_id STRING NOT NULL,
  period_id STRING NOT NULL,
  product_line_id STRING NOT NULL,
...
CREATE OR REPLACE TABLE workspace.hgv_comp.scenario_run (
...
CREATE OR REPLACE TABLE workspace.hgv_comp.scenario_result (
  scenario_id STRING NOT NULL,
...
CREATE OR REPLACE TABLE workspace.hgv_comp.scenario_payout_series (
  scenario_id STRING NOT NULL,
