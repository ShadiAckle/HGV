DELETE FROM workspace.hgv_comp.scenario_payout_series;
DELETE FROM workspace.hgv_comp.scenario_result;
DELETE FROM workspace.hgv_comp.scenario_run;
DELETE FROM workspace.hgv_comp.fact_rep_product_mix;
DELETE FROM workspace.hgv_comp.fact_team_snapshot;
DELETE FROM workspace.hgv_comp.fact_deal_credit;
DELETE FROM workspace.hgv_comp.fact_payout;
DELETE FROM workspace.hgv_comp.fact_quota_attainment;
DELETE FROM workspace.hgv_comp.dim_product_line;
DELETE FROM workspace.hgv_comp.dim_plan_version;
DELETE FROM workspace.hgv_comp.dim_period;
DELETE FROM workspace.hgv_comp.dim_rep;
DELETE FROM workspace.hgv_comp.dim_team;

INSERT INTO workspace.hgv_comp.dim_team VALUES
  ('TEAM-WEST', 'West Coast Sales', 'West'),
  ('TEAM-EAST', 'East Coast Sales', 'East');

INSERT INTO workspace.hgv_comp.dim_period VALUES
  ('2026-Q2', 'Q2 2026', DATE '2026-04-01', DATE '2026-06-30', TRUE),
  ('2025-Q4', 'Q4 2025', DATE '2025-10-01', DATE '2025-12-31', FALSE);

INSERT INTO workspace.hgv_comp.dim_plan_version VALUES
  ('PLAN-2026-V1', '2025 Core Sales Plan', DATE '2026-04-01', NULL),
  ('PLAN-2024-V2', '2024 Core Sales Plan', DATE '2024-07-01', DATE '2025-12-31');

INSERT INTO workspace.hgv_comp.dim_product_line VALUES
...
INSERT INTO workspace.hgv_comp.dim_rep VALUES
...
INSERT INTO workspace.hgv_comp.fact_payout VALUES
...
INSERT INTO workspace.hgv_comp.fact_team_snapshot VALUES
  ('TEAM-WEST', '2026-Q2', 87.00, 3, 2, 15.00, 20.00);

INSERT INTO workspace.hgv_comp.fact_rep_product_mix VALUES
...
INSERT INTO workspace.hgv_comp.scenario_result VALUES
...
INSERT INTO workspace.hgv_comp.scenario_payout_series VALUES
