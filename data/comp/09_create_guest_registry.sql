...
ALTER TABLE workspace.hgv_comp.fact_marketing_tour_payout ADD COLUMN guest_id STRING;
ALTER TABLE workspace.hgv_comp.fact_marketing_tour_payout ADD COLUMN household_id STRING;
ALTER TABLE workspace.hgv_comp.fact_marketing_tour_payout ADD COLUMN planned_tour_location_id STRING;
ALTER TABLE workspace.hgv_comp.fact_marketing_tour_payout ADD COLUMN current_stay_location_id STRING;
ALTER TABLE workspace.hgv_comp.fact_marketing_tour_payout ADD COLUMN lead_source STRING;
ALTER TABLE workspace.hgv_comp.fact_marketing_tour_payout ADD COLUMN abc_score STRING;
ALTER TABLE workspace.hgv_comp.fact_marketing_tour_payout ADD COLUMN package_type STRING;
ALTER TABLE workspace.hgv_comp.fact_marketing_tour_payout ADD COLUMN xref_tour_id STRING;
ALTER TABLE workspace.hgv_comp.fact_marketing_tour_payout ADD COLUMN tour_booked_date DATE;
