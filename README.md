...
Deploy to the default target (premium workspace — see `databricks.yml`):

```bash
npm run build:artifacts
databricks bundle deploy --profile hgv-premium
databricks bundle run app --profile hgv-premium
```
